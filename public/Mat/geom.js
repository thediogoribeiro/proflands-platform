...
function draw_piramide(scene, camera, renderer,tipo,x,z){
  var xrot=0.2;
  if (tipo=="cone") var lados = 400;
  else if (tipo=="piramide"){
    var lados = Math.floor((Math.random() *2) + 3);
    xrot=0.5;
  }
